...
namespace UltraWinBar.Utilities
{
    internal static class FlatTheme
    {
        internal static void LoadResources()
        {
            ...
            if (!dictionaries.Any(dictionary => dictionary.Source?.ToString().EndsWith("Assets/Resources/Brand/FlatControls.xaml", StringComparison.OrdinalIgnoreCase) == true))
                dictionaries.Add(new ResourceDictionary
                {
                    Source = new Uri("pack://application:,,,/UltraWinBar;component/Assets/Resources/Brand/FlatControls.xaml")
                });
        }
