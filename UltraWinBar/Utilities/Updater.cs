...
namespace UltraWinBar.Utilities
{
    public class Updater : IDisposable
    {
        ...
        public readonly string DownloadUrl = ReleaseEndpoints.Releases;

        private readonly HttpClient httpClient = new HttpClient();

        private readonly string _versionUrl = ReleaseEndpoints.LatestReleaseApi;
        ...
        public Updater()
        {
            httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("UltraWinBar");
        ...
        private async Task<bool> CheckForUpdate()
        {
            try
            {
                ...
                if (Version.TryParse(versionInfo?.Version?.TrimStart('v', 'V'), out Version newVersion))
                {
