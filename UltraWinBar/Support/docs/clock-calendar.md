...
Month labels in `../../Assets/Resources/Calendar/HebrewMonths.json` are extracted from Unicode CLDR's
...
The associated Unicode license is distributed in `../../Assets/Resources/Calendar/Unicode-LICENSE.txt`.
