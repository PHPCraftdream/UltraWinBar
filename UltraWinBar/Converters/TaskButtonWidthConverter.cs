...
namespace UltraWinBar.Converters
{
    ...
    // values[4] = closed pinned launcher; values[5] = panel orientation.
    //
    ...
    public class TaskButtonWidthConverter : IMultiValueConverter
    {
        ...
        {
            bool vertical = values.Length > 5 && values[5] is Orientation.Vertical;
            if (values.Length > 4 && values[4] is true && !vertical) return 34d;
