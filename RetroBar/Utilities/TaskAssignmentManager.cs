...
namespace RetroBar.Utilities
{
    ...
    public static class TaskAssignmentManager
    {
        ...
        public static AppBarEdge? GetAssignedEdge(ApplicationWindow window)
        {
            ...
            TaskbarAssignment? windowAssignment = null;
            TaskbarAssignment? appAssignment = null;

            foreach (var assignment in Settings.Instance.TaskbarAssignments)
            {
            ...
            return windowAssignment?.Edge ?? appAssignment?.Edge;
        }
        ...
        public static void AssignToEdge(ApplicationWindow window, AppBarEdge edge, TaskAssignmentMode mode)
        {
            ...
            List<TaskbarAssignment> assignments = Settings.Instance.TaskbarAssignments
                .Where(a => !(a.Mode == mode && a.Identifier == identifier))
                .ToList();

            assignments.Add(new TaskbarAssignment { Identifier = identifier, Edge = edge, Mode = mode });
        ...
        public static void ResetAssignment(ApplicationWindow window)
        {
            ...
            List<TaskbarAssignment> assignments = Settings.Instance.TaskbarAssignments
                .Where(a => !(a.Mode == TaskAssignmentMode.WindowClassAndTitle && windowId != null && a.Identifier == windowId) &&
